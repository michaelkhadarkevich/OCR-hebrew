...
PID_FILE = ROOT / "word_segmenter.pid"
...
if __name__ == "__main__":
    host = "127.0.0.1"
    port = 8773
    url = f"http://localhost:{port}/?v=word-auto-v3"
    print("Word Segmenter - Auto v3 Punctuation Safe")
    print(f"Opening: {url}")
    ...
    try:
        ...
        print("If Word Segmenter Auto v3 is already running, open http://localhost:8773")
