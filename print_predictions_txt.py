...
csv_path = Path('/home/maxim/HTR-VT/output/omer_ariel_cpu_50_blankbias/predictions.csv')
out_path = csv_path.with_suffix('.txt')
with csv_path.open(encoding='utf-8', newline='') as f, out_path.open('w', encoding='utf-8') as out:
